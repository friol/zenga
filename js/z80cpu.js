...
class z80cpu
{
    ...
    initUnprefixedTable()
    {
        ...
        this.unprefixedOpcodes[0x25]=[function() { self.registers.h=self.dec_8bit(self.registers.h); self.incPc(1); }, "DEC H", 4, 0, false];
        ...
        this.unprefixedOpcodes[0x2d]=[function() { self.registers.l=self.dec_8bit(self.registers.l); self.incPc(1); }, "DEC L", 4, 0, false]; // the 2-D opcode
        ...
        this.unprefixedOpcodes[0x40]=[function() { self.registers.b=self.registers.b; self.incPc(1); }, "LD B,B", 4, 0, false];
        this.unprefixedOpcodes[0x41]=[function() { self.registers.b=self.registers.c; self.incPc(1); }, "LD B,C", 4, 0, false];
        this.unprefixedOpcodes[0x42]=[function() { self.registers.b=self.registers.d; self.incPc(1); }, "LD B,D", 4, 0, false];
        this.unprefixedOpcodes[0x43]=[function() { self.registers.b=self.registers.e; self.incPc(1); }, "LD B,E", 4, 0, false];
        ...
        this.unprefixedOpcodes[0x5b]=[function() { self.registers.e=self.registers.e; self.incPc(1); }, "LD E,E", 4, 0, false];
        ...
        this.unprefixedOpcodes[0x68]=[function() { self.registers.l=self.registers.b; self.incPc(1); }, "LD L,B", 4, 0, false];
        ...
        this.unprefixedOpcodes[0x6d]=[function() { self.registers.l=self.registers.l; self.incPc(1); }, "LD L,L", 4, 0, false];
        ...
        this.unprefixedOpcodes[0x74]=[function()
        {
            var addr=self.registers.l|(self.registers.h<<8);
        ...
        this.unprefixedOpcodes[0x7f]=[function() { self.registers.a=self.registers.a; self.incPc(1); }, "LD A,A", 4, 0, false];
        ...
        this.unprefixedOpcodes[0x8b]=[function()
        { 
            self.registers.a=self.adc_8bit(self.registers.a,self.registers.e); 
            self.incPc(1); 
        }, "ADC A,E", 4, 0, false];
        ...
        this.unprefixedOpcodes[0x8d]=[function()
        { 
            self.registers.a=self.adc_8bit(self.registers.a,self.registers.l); 
            self.incPc(1); 
        }, "ADC A,L", 4, 0, false];
    
        this.unprefixedOpcodes[0x8e]=[function()
        { 
        ...
        this.unprefixedOpcodes[0x8f]=[function()
        { 
            self.registers.a=self.adc_8bit(self.registers.a,self.registers.a); 
            self.incPc(1); 
        }, "ADC A,A", 4, 0, false];
        ...
        this.unprefixedOpcodes[0x99]=[function()
        {
            self.registers.a = self.sbc_8bit(self.registers.a, self.registers.c);
            self.incPc(1);
        }, "SBC A,C", 4, 0, false];
    
        this.unprefixedOpcodes[0x9a]=[function()
        {
            self.registers.a = self.sbc_8bit(self.registers.a, self.registers.d);
            self.incPc(1);
        }, "SBC A,D", 4, 0, false];

        this.unprefixedOpcodes[0x9b]=[function()
        {
            self.registers.a = self.sbc_8bit(self.registers.a, self.registers.e);
            self.incPc(1);
        }, "SBC A,E", 4, 0, false];
    
        this.unprefixedOpcodes[0x9c]=[function()
        {
            self.registers.a = self.sbc_8bit(self.registers.a, self.registers.h);
            self.incPc(1);
        }, "SBC A,H", 4, 0, false];

        this.unprefixedOpcodes[0x9d]=[function()
        {
            self.registers.a = self.sbc_8bit(self.registers.a, self.registers.l);
            self.incPc(1);
        }, "SBC A,L", 4, 0, false];
        ...
        this.unprefixedOpcodes[0xa5]=[function()
        { 
            self.registers.a=self.and_8bit(self.registers.a,self.registers.l);
            self.incPc(1); 
        },"AND L", 4, 0, false];
        ...
        this.unprefixedOpcodes[0xba]=[function()
        {
            self.sub_8bit(self.registers.a,self.registers.d);
            self.incPc(1);
        }, "CP D", 4, 0, false];
        ...
        this.unprefixedOpcodes[0xbf]=[function()
        {
            self.sub_8bit(self.registers.a,self.registers.a);
            self.incPc(1);
        }, "CP A", 4, 0, false];
        ...
        this.unprefixedOpcodes[0xc7]=[function()
        {
            self.pushWord(self.registers.pc+1);
            self.registers.pc=0x0;
        }, "RST 00h", 11, 0, false];
        ...
        this.unprefixedOpcodes[0xca]=[function()
        {
            var m1=self.theMMU.readAddr(self.registers.pc+1);
            var m2=self.theMMU.readAddr(self.registers.pc+2);
            if ((self.registers.f&z80flags.FLAG_Z)!=0)
            {
                self.registers.pc=(m2<<8)|m1;
            }
            else
        ...
        this.unprefixedOpcodes[0xd3]=[function()
        { 
            const port=self.theMMU.readAddr(self.registers.pc+1); 
            self.theMMU.writePort(port,self.registers.a); 
            self.incPc(2); 
        }, "OUT (%d),A", 11, 1, false];
        ...
        this.unprefixedOpcodes[0xe8]=[function()
        {
            if (self.registers.f&z80flags.FLAG_PV)
            {
                self.registers.pc=self.popWord();
        ...
        this.unprefixedOpcodes[0xef]=[function()
        {
            self.pushWord(self.registers.pc+1);
        ...
        this.unprefixedOpcodes[0xf9]=[function() 
        {
            var hl=self.registers.l|(self.registers.h<<8);
        ...
        this.unprefixedOpcodes[0xff]=[function()
        {
            self.pushWord(self.registers.pc+1);
    ...
    initEdTable()
    {
        ...
        this.prefixedOpcodes[0x48]=[function()
        {
            ...
            if (self.registers.c == 0) self.registers.f|=z80flags.FLAG_Z;
            else self.registers.f&=~z80flags.FLAG_Z;
            if (self.parityLookUp[self.registers.c]) self.registers.f|=z80flags.FLAG_PV;
            else self.registers.f&=~z80flags.FLAG_PV;
        ...
        this.prefixedOpcodes[0x4a]=[function()
        { 
            var hl=self.registers.l|(self.registers.h<<8);
            var bc=self.registers.c|(self.registers.b<<8);

            const ret=self.adc_16bit(hl,bc);

            self.registers.l=ret&0xff;
            self.registers.h=ret>>8;

            self.incPc(2); 
        }, "ADC HL,BC", 15, 0, false];
        ...
        this.prefixedOpcodes[0x50]=[function()
        {
            ...
            if (self.registers.d == 0) self.registers.f|=z80flags.FLAG_Z;
            else self.registers.f&=~z80flags.FLAG_Z;
            if (self.parityLookUp[self.registers.d]) self.registers.f|=z80flags.FLAG_PV;
            else self.registers.f&=~z80flags.FLAG_PV;
        ...
        this.prefixedOpcodes[0x58]=[function()
        {
            ...
            if (self.registers.e == 0) self.registers.f|=z80flags.FLAG_Z;
            else self.registers.f&=~z80flags.FLAG_Z;
            if (self.parityLookUp[self.registers.e]) self.registers.f|=z80flags.FLAG_PV;
            else self.registers.f&=~z80flags.FLAG_PV;
        ...
        this.prefixedOpcodes[0x62]=[function()
        {
            var hl=self.registers.l|(self.registers.h<<8);
            hl=self.sbc_16bit(hl,hl);
            self.registers.l=hl&0xff;
            self.registers.h=hl>>8;
            self.incPc(2);
        }, "SBC HL,HL", 15, 0, false];
        ...
        this.prefixedOpcodes[0xbb]=[function() { self.executeOutd(); }, "OTDR", 16, 0, false];
    }
    ...
    initCbTable()
    {
        ...
        this.prefixcbOpcodes[0x00]=[function() 
        {
            self.registers.b = self.rlc_8bit(self.registers.b);
            self.incPc(2); 
        }, "RLC B", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x05]=[function() 
        {
            self.registers.l = self.rlc_8bit(self.registers.l);
            self.incPc(2); 
        }, "RLC L", 8, 0, false];
    
        this.prefixcbOpcodes[0x06]=[function()
        { 
            const address=self.registers.l|(self.registers.h<<8);
            const res=self.rlc_8bit(self.theMMU.readAddr(address));
            self.theMMU.writeAddr(address,res);
            self.incPc(2); 
        }, "RLC (HL)", 15, 0, false];
    
        this.prefixcbOpcodes[0x07]=[function() 
        {
            self.registers.a = self.rlc_8bit(self.registers.a);
            self.incPc(2); 
        }, "RLC A", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x09]=[function()
        { 
            self.registers.c=self.rrc_8bit(self.registers.c);
            self.incPc(2); 
        }, "RRC C", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x0c]=[function()
        { 
        ...
        this.prefixcbOpcodes[0x0f]=[function()
        { 
        ...
        this.prefixcbOpcodes[0x13]=[function() 
        {
            self.registers.e = self.rl_8bit(self.registers.e); 
            self.incPc(2); 
        }, "RL E", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x16]=[function()
        { 
            const address=self.registers.l|(self.registers.h<<8);
            const res=self.rl_8bit(self.theMMU.readAddr(address));
            self.theMMU.writeAddr(address,res);
            self.incPc(2); 
        }, "RL (HL)", 15, 0, false];
        ...
        this.prefixcbOpcodes[0x1c]=[function() 
        {
            self.registers.h = self.rr_8bit(self.registers.h); 
            self.incPc(2); 
        }, "RR H", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x26]=[function() 
        {
            const hl=self.registers.l|(self.registers.h<<8);
            const content=self.theMMU.readAddr(hl);
            self.theMMU.writeAddr(hl,self.sla_8bit(content)); 
            self.incPc(2); 
        }, "SLA (HL)", 15, 0, false];
        ...
        this.prefixcbOpcodes[0x28]=[function() 
        {
            self.registers.b = self.sra_8bit(self.registers.b); 
            self.incPc(2); 
        }, "SRA B", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x2b]=[function() 
        {
            self.registers.e = self.sra_8bit(self.registers.e); 
            self.incPc(2); 
        }, "SRA E", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x2d]=[function() 
        {
            self.registers.l = self.sra_8bit(self.registers.l); 
            self.incPc(2); 
        }, "SRA L", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x31]=[function() 
        {
            self.registers.c = self.sll_8bit(self.registers.c); 
            self.incPc(2); 
        }, "SLL C", 8, 0, true];
    
        this.prefixcbOpcodes[0x33]=[function() 
        {
            self.registers.e = self.sll_8bit(self.registers.e); 
            self.incPc(2); 
        }, "SLL E", 8, 0, true];
        ...
        this.prefixcbOpcodes[0x42]=[function() 
        {
            self.bit_8bit(self.registers.d, 0x01); 
            self.incPc(2); 
        }, "BIT 0,D", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x44]=[function() 
        {
            self.bit_8bit(self.registers.h, 0x01); 
            self.incPc(2); 
        }, "BIT 0,H", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x4a]=[function() 
        {
            self.bit_8bit(self.registers.d, 0x02); 
            self.incPc(2); 
        }, "BIT 1,D", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x52]=[function() {self.bit_8bit(self.registers.d, 0x04); self.incPc(2); }, "BIT 2,D", 8, 0, false];
        this.prefixcbOpcodes[0x53]=[function() {self.bit_8bit(self.registers.e, 0x04); self.incPc(2); }, "BIT 2,E", 8, 0, false];
        this.prefixcbOpcodes[0x54]=[function() {self.bit_8bit(self.registers.h, 0x04); self.incPc(2); }, "BIT 2,H", 8, 0, false];
        this.prefixcbOpcodes[0x55]=[function() {self.bit_8bit(self.registers.l, 0x04); self.incPc(2); }, "BIT 2,L", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x59]=[function() {self.bit_8bit(self.registers.c, 0x08); self.incPc(2); }, "BIT 3,C", 8, 0, false];
        this.prefixcbOpcodes[0x5a]=[function() {self.bit_8bit(self.registers.d, 0x08); self.incPc(2); }, "BIT 3,D", 8, 0, false];
        this.prefixcbOpcodes[0x5b]=[function() {self.bit_8bit(self.registers.e, 0x08); self.incPc(2); }, "BIT 3,E", 8, 0, false];
        this.prefixcbOpcodes[0x5c]=[function() {self.bit_8bit(self.registers.h, 0x08); self.incPc(2); }, "BIT 3,H", 8, 0, false];
        this.prefixcbOpcodes[0x5d]=[function() {self.bit_8bit(self.registers.l, 0x08); self.incPc(2); }, "BIT 3,L", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x60]=[function() {self.bit_8bit(self.registers.b, 0x10); self.incPc(2); }, "BIT 4,B", 8, 0, false];
        this.prefixcbOpcodes[0x61]=[function() {self.bit_8bit(self.registers.c, 0x10); self.incPc(2); }, "BIT 4,C", 8, 0, false];
        this.prefixcbOpcodes[0x62]=[function() {self.bit_8bit(self.registers.d, 0x10); self.incPc(2); }, "BIT 4,D", 8, 0, false];
        this.prefixcbOpcodes[0x63]=[function() {self.bit_8bit(self.registers.e, 0x10); self.incPc(2); }, "BIT 4,E", 8, 0, false];
        this.prefixcbOpcodes[0x64]=[function() {self.bit_8bit(self.registers.h, 0x10); self.incPc(2); }, "BIT 4,H", 8, 0, false];
        this.prefixcbOpcodes[0x65]=[function() {self.bit_8bit(self.registers.l, 0x10); self.incPc(2); }, "BIT 4,L", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x68]=[function() {self.bit_8bit(self.registers.b, 0x20); self.incPc(2); }, "BIT 5,B", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x70]=[function() {self.bit_8bit(self.registers.b, 0x40); self.incPc(2); }, "BIT 6,B", 8, 0, false];
        this.prefixcbOpcodes[0x71]=[function() {self.bit_8bit(self.registers.c, 0x40); self.incPc(2); }, "BIT 6,C", 8, 0, false];
        this.prefixcbOpcodes[0x72]=[function() {self.bit_8bit(self.registers.d, 0x40); self.incPc(2); }, "BIT 6,D", 8, 0, false];
        this.prefixcbOpcodes[0x73]=[function() {self.bit_8bit(self.registers.e, 0x40); self.incPc(2); }, "BIT 6,E", 8, 0, false];
        this.prefixcbOpcodes[0x74]=[function() {self.bit_8bit(self.registers.h, 0x40); self.incPc(2); }, "BIT 6,H", 8, 0, false];
        this.prefixcbOpcodes[0x75]=[function() {self.bit_8bit(self.registers.l, 0x40); self.incPc(2); }, "BIT 6,L", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x7c]=[function() {self.bit_8bit(self.registers.h, 0x80); self.incPc(2); }, "BIT 7,H", 8, 0, false];
        this.prefixcbOpcodes[0x7d]=[function() {self.bit_8bit(self.registers.l, 0x80); self.incPc(2); }, "BIT 7,L", 8, 0, false];
        ...
        this.prefixcbOpcodes[0x80]=[function()
        {
        ...
        this.prefixcbOpcodes[0x82]=[function()
        {
            self.registers.d&=~0x01;
            self.incPc(2); 
        }, "RES 0,D", 8, 0, false];
    
        this.prefixcbOpcodes[0x83]=[function()
        {
        ...
        this.prefixcbOpcodes[0x88]=[function()
        {
        ...
        this.prefixcbOpcodes[0x8a]=[function()
        {
            self.registers.d&=~0x02;
            self.incPc(2); 
        }, "RES 1,D", 8, 0, false];
    
        this.prefixcbOpcodes[0x8b]=[function()
        {
            self.registers.e&=~0x02;
            self.incPc(2); 
        }, "RES 1,E", 8, 0, false];
    
        this.prefixcbOpcodes[0x8c]=[function()
        {
            self.registers.h&=~0x02;
            self.incPc(2); 
        }, "RES 1,H", 8, 0, false];

        this.prefixcbOpcodes[0x8d]=[function()
        {
        ...
        this.prefixcbOpcodes[0x8f]=[function()
        {
        ...
        this.prefixcbOpcodes[0x92]=[function()
        {
        ...
        this.prefixcbOpcodes[0x94]=[function()
        {
        ...
        this.prefixcbOpcodes[0x98]=[function()
        {
        ...
        this.prefixcbOpcodes[0x9a]=[function()
        {
            self.registers.d&=~0x08;
            self.incPc(2); 
        }, "RES 3,D", 8, 0, false];
    
        this.prefixcbOpcodes[0x9b]=[function()
        {
            self.registers.e&=~0x08;
            self.incPc(2); 
        }, "RES 3,E", 8, 0, false];

        this.prefixcbOpcodes[0x9d]=[function()
        {
        ...
        this.prefixcbOpcodes[0xa0]=[function()
        {
        ...
        this.prefixcbOpcodes[0xa2]=[function()
        {
        ...
        this.prefixcbOpcodes[0xa6]=[function()
        {
            const hl=self.registers.l|(self.registers.h<<8);
            var content=self.theMMU.readAddr(hl);
            content&=~0x10;
        ...
        this.prefixcbOpcodes[0xa7]=[function()
        {
        ...
        this.prefixcbOpcodes[0xaa]=[function()
        {
        ...
        this.prefixcbOpcodes[0xae]=[function()
        {
            const hl=self.registers.l|(self.registers.h<<8);
            var content=self.theMMU.readAddr(hl);
            content&=~0x20;
        ...
        this.prefixcbOpcodes[0xaf]=[function()
        {
            self.registers.a&=~0x20;
            self.incPc(2); 
        }, "RES 5,A", 8, 0, false];

        this.prefixcbOpcodes[0xb0]=[function()
        {
            self.registers.b&=~0x40;
            self.incPc(2); 
        }, "RES 6,B", 8, 0, false];
            
        this.prefixcbOpcodes[0xb1]=[function()
        {
            self.registers.c&=~0x40;
            self.incPc(2); 
        }, "RES 6,C", 8, 0, false];

        this.prefixcbOpcodes[0xb2]=[function()
        {
            self.registers.d&=~0x40;
            self.incPc(2); 
        }, "RES 6,D", 8, 0, false];
    
        this.prefixcbOpcodes[0xb3]=[function()
        {
            self.registers.e&=~0x40;
            self.incPc(2); 
        }, "RES 6,E", 8, 0, false];
            
        this.prefixcbOpcodes[0xb4]=[function()
        {
            self.registers.h&=~0x40;
            self.incPc(2); 
        }, "RES 6,H", 8, 0, false];

        this.prefixcbOpcodes[0xb5]=[function()
        {
        ...
        this.prefixcbOpcodes[0xba]=[function()
        {
        ...
        this.prefixcbOpcodes[0xbc]=[function()
        {
        ...
        this.prefixcbOpcodes[0xc0]=[function()
        {
            self.registers.b|=0x01;
            self.incPc(2); 
        }, "SET 0,B", 8, 0, false];
    
        this.prefixcbOpcodes[0xc1]=[function()
        {
            self.registers.c|=0x01;
            self.incPc(2); 
        }, "SET 0,C", 8, 0, false];

        this.prefixcbOpcodes[0xc2]=[function()
        {
            self.registers.d|=0x01;
            self.incPc(2); 
        }, "SET 0,D", 8, 0, false];
            
        this.prefixcbOpcodes[0xc3]=[function()
        {
            self.registers.e|=0x01;
            self.incPc(2); 
        }, "SET 0,E", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xc8]=[function()
        {
            self.registers.b|=0x02;
            self.incPc(2); 
        }, "SET 1,B", 8, 0, false];
    
        this.prefixcbOpcodes[0xc9]=[function()
        {
            self.registers.c|=0x02;
            self.incPc(2); 
        }, "SET 1,C", 8, 0, false];

        this.prefixcbOpcodes[0xca]=[function()
        {
            self.registers.d|=0x02;
            self.incPc(2); 
        }, "SET 1,D", 8, 0, false];
    
        this.prefixcbOpcodes[0xcb]=[function()
        {
            self.registers.e|=0x02;
            self.incPc(2); 
        }, "SET 1,E", 8, 0, false];

        this.prefixcbOpcodes[0xcc]=[function()
        {
            self.registers.h|=0x02;
            self.incPc(2); 
        }, "SET 1,H", 8, 0, false];

        this.prefixcbOpcodes[0xcd]=[function()
        {
            self.registers.l|=0x02;
            self.incPc(2); 
        }, "SET 1,L", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xcf]=[function()
        {
            self.registers.a|=0x02;
            self.incPc(2); 
        }, "SET 1,A", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xd1]=[function()
        {
            self.registers.c|=0x04;
            self.incPc(2); 
        }, "SET 2,C", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xd4]=[function()
        {
            self.registers.h|=0x04;
            self.incPc(2); 
        }, "SET 2,H", 8, 0, false];
    
        this.prefixcbOpcodes[0xd5]=[function()
        {
            self.registers.l|=0x04;
            self.incPc(2); 
        }, "SET 2,L", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xd8]=[function()
        {
            self.registers.b|=0x08;
            self.incPc(2); 
        }, "SET 3,B", 8, 0, false];

        this.prefixcbOpcodes[0xd9]=[function()
        {
            self.registers.c|=0x08;
            self.incPc(2); 
        }, "SET 3,C", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xdc]=[function()
        {
            self.registers.h|=0x08;
            self.incPc(2); 
        }, "SET 3,H", 8, 0, false];

        this.prefixcbOpcodes[0xdd]=[function()
        {
            self.registers.l|=0x08;
            self.incPc(2); 
        }, "SET 3,L", 8, 0, false];
            
        this.prefixcbOpcodes[0xde]=[function()
        {
            const hl=self.registers.l|(self.registers.h<<8);
            var content=self.theMMU.readAddr(hl);
            content|=0x08;
        ...
        this.prefixcbOpcodes[0xe0]=[function() 
        { 
            self.registers.b|=0x10;
            self.incPc(2); 
        }, "SET 4,B", 8, 0, false];
    
        this.prefixcbOpcodes[0xe1]=[function() 
        { 
            self.registers.c|=0x10;
            self.incPc(2); 
        }, "SET 4,C", 8, 0, false];

        this.prefixcbOpcodes[0xe2]=[function() 
        { 
            self.registers.d|=0x10;
            self.incPc(2); 
        }, "SET 4,D", 8, 0, false];
    
        this.prefixcbOpcodes[0xe3]=[function() 
        { 
            self.registers.e|=0x10;
            self.incPc(2); 
        }, "SET 4,E", 8, 0, false];
            
        this.prefixcbOpcodes[0xe4]=[function() 
        { 
            self.registers.h|=0x10;
            self.incPc(2); 
        }, "SET 4,H", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xe7]=[function()
        {
            self.registers.a|=0x10;
            self.incPc(2); 
        }, "SET 4,A", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xe9]=[function() 
        { 
            self.registers.c|=0x20;
            self.incPc(2); 
        }, "SET 5,C", 8, 0, false];

        this.prefixcbOpcodes[0xea]=[function() 
        { 
            self.registers.d|=0x20;
            self.incPc(2); 
        }, "SET 5,D", 8, 0, false];
    
        this.prefixcbOpcodes[0xeb]=[function() 
        { 
            self.registers.e|=0x20;
            self.incPc(2); 
        }, "SET 5,E", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xf0]=[function() 
        { 
            self.registers.b|=0x40;
            self.incPc(2); 
        }, "SET 6,B", 8, 0, false];
    
        this.prefixcbOpcodes[0xf1]=[function() 
        { 
            self.registers.c|=0x40;
            self.incPc(2); 
        }, "SET 6,C", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xf3]=[function() 
        { 
            self.registers.e|=0x40;
            self.incPc(2); 
        }, "SET 6,E", 8, 0, false];
    
        this.prefixcbOpcodes[0xf4]=[function() 
        { 
            self.registers.h|=0x40;
            self.incPc(2); 
        }, "SET 6,H", 8, 0, false];

        this.prefixcbOpcodes[0xf5]=[function() 
        { 
            self.registers.l|=0x40;
            self.incPc(2); 
        }, "SET 6,L", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xf8]=[function() 
        { 
            self.registers.b|=0x80;
            self.incPc(2); 
        }, "SET 7,B", 8, 0, false];
    
        this.prefixcbOpcodes[0xf9]=[function() 
        { 
            self.registers.c|=0x80;
            self.incPc(2); 
        }, "SET 7,C", 8, 0, false];
    
        this.prefixcbOpcodes[0xfa]=[function() 
        { 
            self.registers.d|=0x80;
            self.incPc(2); 
        }, "SET 7,D", 8, 0, false];
        ...
        this.prefixcbOpcodes[0xfc]=[function() 
        { 
            self.registers.h|=0x80;
            self.incPc(2); 
        }, "SET 7,H", 8, 0, false];
    
        this.prefixcbOpcodes[0xfd]=[function() 
        { 
            self.registers.l|=0x80;
            self.incPc(2); 
        }, "SET 7,L", 8, 0, false];
    ...
    initFdTable()
    {
        ...
        this.prefixfdOpcodes[0x24]=[function() 
        {
            self.registers.iyh=self.inc_8bit(self.registers.iyh);
            self.incPc(2); 
        }, "INC IYH", 8, 0, true];
        ...
        this.prefixfdOpcodes[0x2b]=[function() 
        {
            var iy=self.registers.iyl|(self.registers.iyh<<8); 
            iy-=1; iy&=0xffff;
            self.registers.iyl=iy&0xff;
        ...
        this.prefixfdOpcodes[0x2c]=[function() 
        {
            self.registers.iyl=self.inc_8bit(self.registers.iyl);
            self.incPc(2); 
        }, "INC IYL", 8, 0, true];
    
        this.prefixfdOpcodes[0x2d]=[function() 
        {
            self.registers.iyl=self.dec_8bit(self.registers.iyl);
            self.incPc(2); 
        }, "DEC IYL", 8, 0, true];
        ...
        this.prefixfdOpcodes[0x35]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            const iy=self.registers.iyl|(self.registers.iyh<<8); 
        ...
        this.prefixfdOpcodes[0x45]=[function() 
        {
            self.registers.b=self.registers.iyl;
            self.incPc(2); 
        }, "LD B,IYL", 8, 0, true];
        ...
        this.prefixfdOpcodes[0x4e]=[function() 
        {
            ...
            self.incPc(3); 
        }, "LD C,(IY+%d)", 19, 1, false];

        this.prefixfdOpcodes[0x54]=[function() 
        {
            self.registers.d=self.registers.iyh;
            self.incPc(2); 
        }, "LD D,IYH", 8, 0, true];
        ...
        this.prefixfdOpcodes[0x5d]=[function() 
        {
            self.registers.e=self.registers.iyl;
            self.incPc(2); 
        }, "LD E,IYL", 8, 0, true];
        ...
        this.prefixfdOpcodes[0x67]=[function() 
        {
            self.registers.iyh=self.registers.a;
            self.incPc(2); 
        }, "LD IYH,A", 8, 0, true];

        this.prefixfdOpcodes[0x68]=[function() 
        {
            self.registers.iyl=self.registers.b;
            self.incPc(2); 
        }, "LD IYL,B", 8, 0, true];
        ...
        this.prefixfdOpcodes[0x6f]=[function() 
        {
            self.registers.iyl=self.registers.a;
            self.incPc(2); 
        }, "LD IYL,A", 8, 0, false];
        ...
        this.prefixfdOpcodes[0x71]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            const iy=self.registers.iyl|(self.registers.iyh<<8); 
        ...
        this.prefixfdOpcodes[0x7e]=[function() 
        {
            ...
            self.registers.a=self.theMMU.readAddr(addr);
            self.incPc(3); 
        }, "LD A,(IY+%d)", 19, 1, false];

        this.prefixfdOpcodes[0x84]=[function() 
        {
            self.registers.a=self.add_8bit(self.registers.a,self.registers.iyh);
            self.incPc(2); 
        }, "ADD A,IYH", 8, 0, true];

        this.prefixfdOpcodes[0x85]=[function() 
        {
            self.registers.a=self.add_8bit(self.registers.a,self.registers.iyl);
            self.incPc(2); 
        }, "ADD A,IYL", 8, 0, true];
        ...
        this.prefixfdOpcodes[0x8e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            const iy=self.registers.iyl|(self.registers.iyh<<8); 
        ...
        this.prefixfdOpcodes[0x95]=[function() 
        { 
            self.registers.a=self.sub_8bit(self.registers.a,self.registers.iyl);
            self.incPc(2); 
        }, "SUB IYL", 8, 0, true];
        ...
        this.prefixfdOpcodes[0x9e]=[function()
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            const iy=self.registers.iyl|(self.registers.iyh<<8); 
            ...
            self.incPc(3);
        }, "SBC A,(IY+%d)", 19, 1, false];
    
        this.prefixfdOpcodes[0xa6]=[function()
        { 
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            const iy=self.registers.iyl|(self.registers.iyh<<8); 
        ...
        this.prefixfdOpcodes[0xae]=[function()
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            const iy=self.registers.iyl|(self.registers.iyh<<8); 
        ...
        this.prefixfdOpcodes[0xb4]=[function()
        {
            self.registers.a=self.or_8bit(self.registers.a,self.registers.iyh);
            self.incPc(2);
        }, "OR IYH", 8, 0, true];
    
        this.prefixfdOpcodes[0xb5]=[function()
        {
            self.registers.a=self.or_8bit(self.registers.a,self.registers.iyl);
            self.incPc(2);
        }, "OR IYL", 8, 0, true];
        ...
        this.prefixfdOpcodes[0xe3]=[function() 
        { 
            var tmp=self.theMMU.readAddr(self.registers.sp);
            self.theMMU.writeAddr(self.registers.sp,self.registers.iyl);
            self.registers.iyl=tmp;

            tmp=self.theMMU.readAddr((self.registers.sp+1)&0xffff);
            self.theMMU.writeAddr((self.registers.sp+1)&0xffff,self.registers.iyh);
            self.registers.iyh=tmp;
        ...
        this.prefixfdOpcodes[0xe9]=[function() 
        {
            const iy=self.registers.iyl|(self.registers.iyh<<8); 
            self.registers.pc=iy;
        }, "JP (IY)", 8, 0, false];
    ...
    initDdTable()
    {
        ...
        this.prefixddOpcodes[0x25]=[function() 
        {
            self.registers.ixh=self.dec_8bit(self.registers.ixh);
            self.incPc(2); 
        }, "DEC IXH", 8, 0, true];
        ...
        this.prefixddOpcodes[0x67]=[function() 
        {
        ...
        this.prefixddOpcodes[0x6f]=[function() 
        {
            self.registers.ixl=self.registers.a;
            self.incPc(2); 
        }, "LD IXL,A", 8, 0, true];
        ...
        this.prefixddOpcodes[0x7c]=[function() 
        {
            self.registers.a=self.registers.ixh;
            self.incPc(2); 
        }, "LD A,IXH", 8, 0, true];
        ...
        this.prefixddOpcodes[0x85]=[function()
        { 
            self.registers.a=self.add_8bit(self.registers.a,self.registers.ixl); 
            self.incPc(2); 
        }, "ADD A,IXL", 8, 0, false];
        ...
        this.prefixddOpcodes[0x8e]=[function()
        { 
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            const ix=self.registers.ixl|(self.registers.ixh<<8); 
            ...
            self.registers.a=self.adc_8bit(self.registers.a,mem); 
            self.incPc(3); 
        ...
        this.prefixddOpcodes[0xb5]=[function() 
        {
            self.registers.a=self.or_8bit(self.registers.a,self.registers.ixl);
            self.incPc(2); 
        }, "OR IXL", 8, 0, true];
        ...
        this.prefixddOpcodes[0xbc]=[function()
        {
            self.sub_8bit(self.registers.a,self.registers.ixh);
            self.incPc(2);
        }, "CP IXH", 8, 0, true];

        this.prefixddOpcodes[0xbd]=[function()
        {
            self.sub_8bit(self.registers.a,self.registers.ixl);
            self.incPc(2);
        }, "CP IXL", 8, 0, true];
        ...
        this.prefixddOpcodes[0xe3]=[function() 
        { 
            var tmp=self.theMMU.readAddr(self.registers.sp);
            self.theMMU.writeAddr(self.registers.sp,self.registers.ixl);
            self.registers.ixl=tmp;

            tmp=self.theMMU.readAddr((self.registers.sp+1)&0xffff);
            self.theMMU.writeAddr((self.registers.sp+1)&0xffff,self.registers.ixh);
            self.registers.ixh=tmp;
        ...
        this.prefixddOpcodes[0xe9]=[function()
        {
            const ix=self.registers.ixl|(self.registers.ixh<<8);
            self.registers.pc=ix;
        }, "JP (IX)", 8, 0, false];
    ...
    initDdCbTable()
    {
        ...
        this.prefixddcbOpcodes[0x1e]=[function()
        { 
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            const res=self.rr_8bit(self.theMMU.readAddr(addr));
            self.theMMU.writeAddr(addr,res);
            self.incPc(4); 
        }, "RR (IX+%d)", 23, 0, false];
        ...
        this.prefixddcbOpcodes[0x2e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixddcbOpcodes[0x4e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.bit_8bit(mem,0x02);
            self.incPc(4); 
        }, "BIT 1,(IX+%d)", 20, 1, false];
        ...
        this.prefixddcbOpcodes[0x86]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixddcbOpcodes[0x96]=[function() 
        {
            ...
            self.theMMU.writeAddr(addr,mem);
            self.incPc(4); 
        }, "RES 2,(IX+%d)", 23, 1, false];

        this.prefixddcbOpcodes[0x9e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "RES 3,(IX+%d)", 23, 1, false];

        this.prefixddcbOpcodes[0xa6]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "RES 4,(IX+%d)", 23, 1, false];
            
        this.prefixddcbOpcodes[0xae]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixddcbOpcodes[0xbe]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixddcbOpcodes[0xce]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixddcbOpcodes[0xde]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "SET 3,(IX+%d)", 23, 1, false];

        this.prefixddcbOpcodes[0xe6]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
    ...
    initFdCbTable()
    {
        ...
        this.prefixfdcbOpcodes[0x16]=[function()
        { 
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            const res=self.rl_8bit(self.theMMU.readAddr(addr));
            self.theMMU.writeAddr(addr,res);
            self.incPc(4); 
        }, "RL (IY+%d)", 23, 0, false];
            
        this.prefixfdcbOpcodes[0x1e]=[function()
        { 
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixfdcbOpcodes[0x26]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixfdcbOpcodes[0x2e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixfdcbOpcodes[0x46]=[function() 
        {
            ...
            self.bit_8bit(mem,0x01);
            self.incPc(4); 
        }, "BIT 0,(IY+%d)", 20, 1, false];

        this.prefixfdcbOpcodes[0x4e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.bit_8bit(mem,0x02);
            self.incPc(4); 
        }, "BIT 1,(IY+%d)", 20, 1, false];
            
        this.prefixfdcbOpcodes[0x56]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.bit_8bit(mem,0x04);
            self.incPc(4); 
        }, "BIT 2,(IY+%d)", 20, 1, false];

        this.prefixfdcbOpcodes[0x5e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.bit_8bit(mem,0x08);
            self.incPc(4); 
        }, "BIT 3,(IY+%d)", 20, 1, false];
            
        this.prefixfdcbOpcodes[0x66]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.bit_8bit(mem,0x10);
            self.incPc(4); 
        }, "BIT 4,(IY+%d)", 20, 1, false];

        this.prefixfdcbOpcodes[0x6e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.bit_8bit(mem,0x20);
            self.incPc(4); 
        }, "BIT 5,(IY+%d)", 20, 1, false];

        this.prefixfdcbOpcodes[0x76]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixfdcbOpcodes[0x86]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "RES 0,(IY+%d)", 23, 1, false];
    
        this.prefixfdcbOpcodes[0x8e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "RES 1,(IY+%d)", 23, 1, false];

        this.prefixfdcbOpcodes[0x96]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "RES 2,(IY+%d)", 23, 1, false];
    
        this.prefixfdcbOpcodes[0x9e]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
        ...
        this.prefixfdcbOpcodes[0xae]=[function() 
        {
            ...
            self.incPc(4); 
        }, "RES 5,(IY+%d)", 23, 1, false];
    
        this.prefixfdcbOpcodes[0xb6]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "RES 6,(IY+%d)", 23, 1, false];

        this.prefixfdcbOpcodes[0xbe]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "RES 7,(IY+%d)", 23, 1, false];
            
        this.prefixfdcbOpcodes[0xc6]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "SET 0,(IY+%d)", 23, 1, false];

        this.prefixfdcbOpcodes[0xce]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "SET 1,(IY+%d)", 23, 1, false];

        this.prefixfdcbOpcodes[0xd6]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "SET 2,(IY+%d)", 23, 1, false];
            
        this.prefixfdcbOpcodes[0xde]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "SET 3,(IY+%d)", 23, 1, false];

        this.prefixfdcbOpcodes[0xe6]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "SET 4,(IY+%d)", 23, 1, false];
    
        this.prefixfdcbOpcodes[0xee]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "SET 5,(IY+%d)", 23, 1, false];
            
        this.prefixfdcbOpcodes[0xf6]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
            ...
            self.incPc(4); 
        }, "SET 6,(IY+%d)", 23, 1, false];
    
        this.prefixfdcbOpcodes[0xfe]=[function() 
        {
            var m1=self.theMMU.readAddr(self.registers.pc+2);
    ...
    debugDecodeOpcode(thePC,retStruct)
    {
        ...
        else if (b1==0xdd)
        {
            ...
            if (b2==0xcb)
            {
                ...
                var b4=this.theMMU.readAddr(thePC+3);
